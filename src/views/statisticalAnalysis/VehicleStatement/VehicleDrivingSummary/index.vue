    ...
    <div class="app-container">
        ...
        <el-form ref="form" :model="listQuery" label-width="70px" inline style="background: #fff; margin: 0 20px; padding: 13px 10px 0 20px; border-radius: 5px; box-shadow: 0 0 10px #ccc">
          <el-form-item label="运营商平台">
            <el-select   v-model="listQuery.platformId" placeholder="请选择" style="width:120px;" size="small" clearable  filterable>
          ...
          <el-form-item label="选择车辆">
            <el-input placeholder="请选择车辆" v-model.trim="listQuery.vehicleNo" style="width:120px;" size="small" readonly @focus="showChooseCar" clearable></el-input>
          </el-form-item>
...
import { runSummary, runReport } from '@/api/statistics/statistics' // Excel导出
...
export default {
  ...
  methods: {
    ...
    getSpeedList() { // 分页获取智能预警列表
      ...
      runSummary(this.listQuery).then(res => {
        if (res.code === 0) {
