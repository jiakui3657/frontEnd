...
import { onlineRate, onlineRateExcel } from '@/api/statistics/statistics' // Excel导出
...
export default {
  ...
  methods: {
    ...
    alarmexport() {
      ...
      onlineRateExcel(this.listQuery).then(result => {
    ...
    downloads(data) {
      ...
      link.href = url
      link.setAttribute('download', '车辆上级率明细.xls')
