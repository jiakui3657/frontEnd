          ...
          <el-col :span="12">
            <div class="grid-content bg-purple-light" style="position: relative; max-height: 292px;">
              ...
              <div style="position:absolute; bottom: 5px; right: 5px;">
                <el-button icon="el-icon-d-arrow-left" class="videoBtns" @click="speedsub(params.speed1d, 1)"></el-button>
                ...
                <el-button class="videoBtns" icon="el-icon-d-arrow-right" @click="speedadd(params.speed1d, 1)"></el-button>
                <el-button class="videoBtns" @click="doPlay(player1, 1)">▶</el-button>
                <el-button class="videoBtns" @click="doPause(player1, 1)">█</el-button>
              </div>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="grid-content bg-purple-light" style="position: relative; max-height: 292px;">
              ...
              <div style="position:absolute; bottom: 5px; right: 5px;">
                <el-button class="videoBtns" icon="el-icon-d-arrow-left" @click="speedsub(params.speed2d, 2)"></el-button>
                <!--<el-button type="primary" icon="" size="mini">X1</el-button>-->
                ...
                <el-button class="videoBtns" icon="el-icon-d-arrow-right" @click="speedadd(params.speed2d, 2)"></el-button>
                <el-button class="videoBtns" @click="doPlay(player2, 2)">▶</el-button>
                <el-button class="videoBtns" @click="doPause(player2, 2)">█</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="12">
            <div class="grid-content bg-purple" style="position: relative; max-height: 292px;">
              ...
              <div style="position:absolute; bottom: 5px; right: 5px;">
                <el-button class="videoBtns" icon="el-icon-d-arrow-left" @click="speedsub(params.speed3d, 3)"></el-button>
                <!--<el-button type="primary" icon="" size="mini">X1</el-button>-->
                ...
                <el-button class="videoBtns" icon="el-icon-d-arrow-right" @click="speedadd(params.speed3d, 3)"></el-button>
                <el-button class="videoBtns" @click="doPlay(player3, 3)">▶</el-button>
                <el-button class="videoBtns" @click="doPause(player3, 3)">█</el-button>
              </div>
            </div>
          </el-col>
          <el-col :span="12">
            <div class="grid-content bg-purple-light" style="position: relative; max-height: 292px;">
              ...
              <div style="position:absolute; bottom: 5px; right: 5px;">
                <el-button class="videoBtns" icon="el-icon-d-arrow-left" @click="speedsub(params.speed4d, 4)"></el-button>
                <!--<el-button type="primary" icon="" size="mini">X1</el-button>-->
                ...
                <el-button class="videoBtns" icon="el-icon-d-arrow-right" @click="speedadd(params.speed4d, 4)"></el-button>
                <el-button class="videoBtns" @click="doPlay(player4, 4)">▶</el-button>
                <el-button class="videoBtns" @click="doPause(player4, 4)">█</el-button>
              </div>
            </div>
          </el-col>
        </el-row>
