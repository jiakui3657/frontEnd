  ...
  <div class="app-container">
    <el-container>
      <el-header style="height:30px;">
        <el-form :inline="true" :model="query" class="demo-form-inline">
          <el-form-item>
            <el-button type="primary" class="filter-btn" icon="el-icon-plus" @click="handleCreate" size="small">新增</el-button>
          </el-form-item>
          <el-form-item>
            <el-input v-model="query.name" size="small" style="width: 200px;margin-left:50px;" class="filter-item" placeholder="字典名称"></el-input>
          </el-form-item>
          <el-form-item>
            <el-button size="small" class="filter-item filter-btn" type="primary" icon="el-icon-search" @click="handleFilter(query.name)">查询</el-button>
          </el-form-item>
        </el-form>
      </el-header>
      <el-main>
        <el-table :data="data" :columns="columns" v-loading.body="listLoading" border stripe highlight-current-row style="width:100%;" :header-cell-style="{ 'background-color': '#5F7ABF', 'color': '#fff', border: 'none !important' }">
          ...
          <el-table-column align="center" label="操作" width="200px;">
            <template slot-scope="scope">
              <el-button type="primary" size="small" icon="el-icon-edit" class="filter-btn"  @click="handleEdit(scope.row.id)">编辑</el-button>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus==='create'" class="filter-btn" type="primary" @click="handleConfirm">确 定</el-button>
        <el-button v-else type="primary" class="filter-btn" @click="updateData">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getList() { // 分页获取字典列表
      ...
      this.listQuery.name = this.query.name
