<template>
  <div class="app-container">
    <el-header style="padding:0;">
      <el-button type="primary" icon="el-icon-plus" class="filter-btn" size="small" @click="handleCreate()">新增</el-button>
    </el-header>

    <tree-table :data="data" :columns="columns" border v-loading.body="listLoading" :header-cell-style="{ 'background-color': '#5F7ABF', 'color': '#fff', border: 'none !important' }">
      <el-table-column align="center" label="操作" fixed="right">
        <template slot-scope="scope">
          <el-button type="primary" class="filter-btn" size="small" icon="el-icon-edit" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button type="danger" size="small" icon="el-icon-delete" @click="handleDelete(scope.row)">删除</el-button>
          <el-button type="info" size="small" icon="el-icon-plus" @click="handleCreate(scope.row)">新增</el-button>
        </template>
      </el-table-column>
    </tree-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" :close-on-click-modal="false">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-if="dialogStatus=='create'" type="primary" class="filter-btn" @click="handleConfirm">确 定</el-button>
