<template>
    <div style="margin:15px 0;height:500px;">
      <div style="float:left;width:20%;margin:0;padding:0 20px 0 0;">
        <div style="height:500px;box-shadow: 0 0 10px #ccc;border-radius:5px;">
          <div style="height:70px;width:100%;position:relative;">
            <img src="../../../assets/navicon/card1.png" width="100%" height="100%">
            <h4 style="position:absolute;top:0;margin:10px 0 0 10px;color:#fff;">车辆入网指数排名</h4>
          ...
          <div style="height:430px;padding:15px 10px;">
            <ul style="width:100%;height:100%;padding:0;margin:0;">
              <li style="list-style:none;" v-for="item in vehicleNetworkOptions" :key="item.owers_id">
                <el-row>
                  <el-col :span="5" style="text-align:center;"><span>NO.{{item.ordinal}}</span></el-col>
                  <el-col :span="19">
      ...
      <div style="float:left;width:20%;margin:0;padding:0 20px 0 0;">
        <div style="height:500px;box-shadow: 0 0 10px #ccc;border-radius:5px;">
          <div style="height:70px;width:100%;position:relative;">
            <img src="../../../assets/navicon/card2.png" width="100%" height="100%">
            <h4 style="position:absolute;top:0;margin:10px 0 0 10px;color:#fff;">车辆上线指数排名</h4>
            <p style="position:absolute;bottom:10px;margin:0 0 0 10px;font-size:13px;color:#fff;">
          ...
          <div style="height:430px;padding:15px 10px;">
            <ul style="width:100%;height:100%;padding:0;margin:0;">
              <li style="list-style:none;" v-for="item in vehicleUpLineOptions" :key="item.owers_id">
                <el-row>
                  <el-col :span="5" style="text-align:center;"><span>NO.{{item.ordinal}}</span></el-col>
                  <el-col :span="19">
                    <div style="width:75%;display: inline-block;">
                    ...
                    <div style="width:20%;display: inline-block;color:#EC4D66;text-align:center;">{{item.score}}</div>
                  </el-col>
                </el-row>
                <el-row>
                  <el-col :offset="5" :span="19">
      ...
      <div style="float:left;width:20%;margin:0;padding:0 20px 0 0;">
        <div style="height:500px;box-shadow: 0 0 10px #ccc;border-radius:5px;">
          <div style="height:70px;width:100%;position:relative;">
            <img src="../../../assets/navicon/card3.png" width="100%" height="100%">
            <h4 style="position:absolute;top:0;margin:10px 0 0 10px;color:#fff;">车辆报警指数排名</h4>
            <p style="position:absolute;bottom:10px;margin:0 0 0 10px;font-size:13px;color:#fff;">
          ...
          <div style="height:430px;padding:15px 10px;">
            <ul style="width:100%;height:100%;padding:0;margin:0;">
              <li style="list-style:none;" v-for="item in vehicleAlarmOptions" :key="item.owers_id">
                <el-row>
                  <el-col :span="5" style="text-align:center;"><span>NO.{{item.ordinal}}</span></el-col>
                  <el-col :span="19">
                    <div style="width:75%;display: inline-block;">
      ...
      <div style="float:left;width:20%;margin:0;padding:0 20px 0 0;">
        <div style="height:500px;box-shadow: 0 0 10px #ccc;border-radius:5px;">
          <div style="height:70px;width:100%;position:relative;">
            <img src="../../../assets/navicon/card4.png" width="100%" height="100%">
            <h4 style="position:absolute;top:0;margin:10px 0 0 10px;color:#fff;">防控报警指数排名</h4>
            <p style="position:absolute;bottom:10px;margin:0 0 0 10px;font-size:13px;color:#fff;">
          ...
          <div style="height:430px;padding:15px 10px;">
            <ul style="width:100%;height:100%;padding:0;margin:0;">
              <li style="list-style:none;" v-for="item in preventionOptions" :key="item.owers_id">
                <el-row>
                  <el-col :span="5" style="text-align:center;"><span>NO.{{item.ordinal}}</span></el-col>
                  <el-col :span="19">
                    <div style="width:75%;display: inline-block;">
      ...
      <div style="float:left;width:20%;margin:0;padding:0;">
        <div style="height:500px;box-shadow: 0 0 10px #ccc;border-radius:5px;">
          <div style="height:70px;width:100%;position:relative;">
            <img src="../../../assets/navicon/card5.png" width="100%" height="100%">
            <h4 style="position:absolute;top:0;margin:10px 0 0 10px;color:#fff;">违规运营指数排名</h4>
            <p style="position:absolute;bottom:10px;margin:0 0 0 10px;font-size:13px;color:#fff;">
          ...
          <div style="height:430px;padding:15px 10px;">
            <ul style="width:100%;height:100%;padding:0;margin:0;">
              <li style="list-style:none;" v-for="item in violationOptions" :key="item.owers_id">
                <el-row>
                  <el-col :span="5" style="text-align:center;"><span>NO.{{item.ordinal}}</span></el-col>
                  <el-col :span="19">
                    <div style="width:75%;display: inline-block;">
  ...
  export default {
    ...
    data() {
      return {
        ...
        sortType_upline: 1,
        sortType_alarm: 1,
        sortType_violation: 1,
        sortType_prevention: 1
      }
    },
    watch: {
      ...
      vehicleUpLine(val, oldVal) {
        if (val && val.length !== 0) {
          this.vehicleUpLineOptions = val
        }
      },
      vehicleAlarm(val, oldVal) {
        if (val && val.length !== 0) {
          this.vehicleAlarmOptions = val
        }
      },
      violation(val, oldVal) {
        if (val && val.length !== 0) {
          this.violationOptions = val
        }
      },
      prevention(val, oldVal) {
        if (val && val.length !== 0) {
          this.preventionOptions = val
        }
      }
    },
    methods: {
