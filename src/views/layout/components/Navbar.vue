...
<el-menu
  ...
  <el-submenu index="1">
    <template slot="title">基础档案</template>
    <el-menu-item index="/base/device">终端档案管理</el-menu-item>
    <el-menu-item index="/base/vehicle">车辆档案管理</el-menu-item>
    <el-menu-item index="/base/driver">驾驶员档案管理</el-menu-item>
    <el-menu-item index="/base/platform">接入平台管理</el-menu-item>
  </el-submenu>
